...
import static TJlexer.LexicalAnalyzer.getStartOfString;                // added by me
import static TJlexer.LexicalAnalyzer.getEndOfString;                 // added by me
import static TJlexer.LexicalAnalyzer.getCurrentValue;                 // added by me
  ...
  private static void expr1() throws SourceFileErrorException
  {
    ...
    switch (getCurrentToken()) {
	  ...
	  case LPAREN :  accept(LPAREN);
	   ...
	   case NOT    :    accept(NOT);                          //   need stuff in this case
	                    expr1();
						new NOTinstr();
	                    break;
	   
	   case UNSIGNEDINT : new PUSHNUMinstr(getCurrentValue()); 
	                      accept(UNSIGNEDINT);
	                      break;
	   
	   			
	   case NEW :    accept(NEW);                        //   need stuff in this case
	                 accept(INT);
					 accept(LBRACKET);
					 expr3();
					 accept(RBRACKET);
